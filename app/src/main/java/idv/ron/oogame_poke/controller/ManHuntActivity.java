...
// 我的寶可夢捕捉頁面
public class ManHuntActivity extends AppCompatActivity {
    private Pokemon fieldPokemon, myPokemon;
    private ImageView ivFieldPokemon, ivMyPokemon, ivRage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_man_hunt);
    ...
    private void handleViews() {
        ...
        ivMyPokemon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 男人沒有魅力就結束，回到第一頁（MainActivity）
                if (fieldPokemon.getPopulation() <= 0) {
                    catchResult(true);
    ...
    private void catchResult(boolean catchSuccess) {
        if (catchSuccess) {
            // 抓到男人，先將該男人的HP加滿後再存入我的百寶箱內
            fieldPokemon.setPopulation(fieldPokemon.getFullPopulation());
            Pokemon.getMyPokemons().add(fieldPokemon);
            // 晃動男人的ImageView代表被有效攻擊
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    alphaAnimation.setAnimationListener(new Animation.AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ...
                            toast = Toast.makeText(ManHuntActivity.this,
            ...
            toast = Toast.makeText(ManHuntActivity.this, text, Toast.LENGTH_SHORT);
